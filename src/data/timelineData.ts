...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: `My love for tech started with gaming—Assassin's Creed, RuneScape, every console I could get my hands on. My older brother's friend, Mark, became my mentor. He showed me OverTheWire and walked me through it line-by-line, giving me a head start and inspiring me to major in Computer Science.`,
    icon: faGamepad,
    category: "education",
    era: "The Spark",
    image:
